...
'''
ottotrechos_jusante = importar_camada_bdg(nome_tabela_bdg='ottotrechos_jusante', nome_schema_bdg=parametros_conexao['schema_cenario'], nome_camada='camada_ottotrechos_jusante')
simbologia_ottotrechos_jusante = {'r':200, 'g':200, 'b':200, 'a':10}
