...
for ponto in pontos_monitoramento.getFeatures():
    ...
    sql = f'''
            SELECT COUNT(ETA) AS numero_etas
            FROM intersecao_etas_ottobacias
    ...
    for feature in features:
        numero_etas = feature['numero_etas']
        dados.append([id, cod_otto, numero_etas])

# Converter os dados para um DataFrame do pandas
df = pd.DataFrame(dados, columns=['id_ponto_monit', 'cod_otto', 'numero_etas'])

# Salvar o DataFrame em um arquivo Excel
df.to_excel('C:/Users/brunoguterres/Desktop/analises_william/resultados/etas/numero_etas_montante.xlsx', index=False)
